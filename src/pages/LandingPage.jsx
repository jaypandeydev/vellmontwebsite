  ...
  return (
    <main className="min-h-screen bg-white text-neutral-900 font-sans antialiased">
      <Seo
        ...
        description="Vellmont is a software studio building production tools for Indian SMBs — clinic queue management (MedQuePMS), astrology marketplace (Vedjyotix), tour operator OS (Vellroute), tutoring platform (Tutora), invitation manager (InviteSync), and GST invoicing (Vellbill). Six products live, custom builds available."
