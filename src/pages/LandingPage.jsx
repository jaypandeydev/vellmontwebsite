  ...
  return (
    <main className="min-h-screen bg-[#050816] text-neutral-100 font-sans antialiased">
      <Seo
        ...
        description="Vellmont is an AI product studio building production-grade SaaS for healthcare (MedQuePMS), tourism (Vellroute), education (Tutoro), astrology (Vedjyotix), invitation management (InviteSync) and GST invoicing (Vellbill). Six products shipped across India + UAE; custom AI builds available."
